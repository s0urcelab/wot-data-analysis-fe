...
const MODS_DL = `${DL_HOST}/s0urce.box.combat.eff.wotmod`;
const MODS_ATLAS_DL = `${DL_HOST}/s0urce.box.combat.eff.atlas.wotmod`;
...
function BoxCE() {
  ...
  return (
    <>
      ...
      <ToolModal key={isModalVisible} visible={isModalVisible} onClose={() => setVisible(false)} />
    </>
  );
}
